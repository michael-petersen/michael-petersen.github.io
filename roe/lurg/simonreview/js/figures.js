...
var yValue1 = function(d) { return d.MV;},
    yScale1 = d3.scaleLinear().domain([3,-14]).range([height, 0]),
...
var colorscale1 = d3.scaleSequential(d3.interpolateBlues).domain([0,1]),
    ...
    cValue1 = function(d) {
      if ( d.Dwarf=="Centaurus I" ||  d.Dwarf=="Eridanus IV" ||  d.Dwarf=="Pegasus IV" || d.Dwarf=="Delve 3" || d.Dwarf=="Delve 4" || d.Dwarf=="Virgo II" || d.Dwarf=="Delve 5" || d.Dwarf=="Bootes V" || d.Dwarf=="Leo Minor I" || d.Dwarf=="UNIONS 1")
...
fig1.append("text").attr("x", 120).attr("y", 30).text("Newly discovered Ultrafaints (Cerny 2022a,b, Heiger 2023, Smith 2023)").style("font-size", "15px").attr("alignment-baseline","middle")
